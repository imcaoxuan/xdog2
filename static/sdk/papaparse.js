...
amis.define('b0801d0', function (require, exports, module, define) {
  ...
  */
    !function (e, t) {
            ...
            parse: function (e, t) {
                ...
                function h(e, t, r) {
                    ...
                    for (var o = 0; o < t.length; o++) {
                        var u = n ? e.length : t[o].length, h = !1,
        ...
        function r(m) {
            var a, o, u, i = Math.pow(2, 53), n = -i, s = /^\s*-?(\d+\.?|\.\d+|\d+\.\d+)([eE][-+]?\d+)?\s*$/,
            ...
            this.parse = function (e, t, r) {
                ...
                if (m.newline || (m.newline = function (e, t) {
                    ...
                    var r = new RegExp(Q(t) + "([^]*?)" + Q(t), "gm"), i = (e = e.replace(r, "")).split("\r"),
        ...
        function E(j) {
            var z, M = (j = j || {}).delimiter, P = j.newline, U = j.comments, q = j.step, N = j.preview,
                B = j.fastMode, K = z = void 0 === j.quoteChar || null === j.quoteChar ? '"' : j.quoteChar;
            ...
            this.parse = function (i, t, r) {
                ...
                function L(e) {
                    return {
                        data: u,
                        errors: h,
                        meta: {delimiter: M, linebreak: P, aborted: H, truncated: !!e, cursor: d + (t || 0)}
                    }
                }
